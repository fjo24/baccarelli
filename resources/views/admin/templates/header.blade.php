        ...
        <div class="container" style="width: 89%;">
            <div class="row">
                ...
                <div class="contenedor  item-flex" style="height: 32px;float: left!important;text-transform: uppercase;">
                    <a href="areaclientes.php?active=area" style="color: #F04596" class="fuente-barra <?php if(isset($_GET['active']) && $_GET['active'] == 'area'){ echo 'active-barra';} ?>">&nbsp;&nbsp; BIENVENIDO, {{Auth()->user()->username }},
                        ADMINISTRADOR <a class="right" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" style="text-transform: capitalize;line-height: 125%;color: #595959">
                            &nbsp;&nbsp; (Cerrar Sesión)
            ...
            <ul class="navb fuenteO hidden-xs">
                <div class="container-flex">
                    ...
                    <li class=" item-flex">
                        ...
                        <a href="{{route('baccarelli.presupuestos')}}" style="color: #F04596!important;" class="itm-menu <?php if(isset($_GET['active']) && $_GET['active'] == 'accesorios'){ echo 'active-link';} ?>">
                            PRESUPUESTOS
                        </a>
                        @else
                        <a href="{{route('baccarelli.presupuestos')}}" class="itm-menu <?php if(isset($_GET['active']) && $_GET['active'] == 'accesorios'){ echo 'active-link';} ?>">
                            PRESUPUESTOS
                        </a>
                        @endif
                    </li>
                    ...
                    <li class=" item-flex">
                        @if ($activo=='pedidos')
                        <a href="{{route('pedidosadmin.index')}}" style="color: #F04596!important;" href="" class="itm-menu <?php if(isset($_GET['active']) && $_GET['active'] == 'trabajos'){ echo 'active-link';} ?>">
                            PEDIDOS
                        </a>
                        @else
                        <a href="{{route('pedidosadmin.index')}}" class="itm-menu <?php if(isset($_GET['active']) && $_GET['active'] == 'accesorios'){ echo 'active-link';} ?>">
                            PEDIDOS
                        </a>
                        @endif
                    </li>
