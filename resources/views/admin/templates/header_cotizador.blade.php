...
<div class="container" style="width: 89%;">
        <div class="row" >
          ...
          <div class="contenedor  item-flex" style="height: 32px;float: left!important;text-transform: uppercase;">
            <a href="areaclientes.php?active=area" style="color: #F04596" class="fuente-barra <?php if(isset($_GET['active']) && $_GET['active'] == 'area'){ echo 'active-barra';} ?>">&nbsp;&nbsp; BIENVENIDO, {{Auth()->user()->username }} DE HURLINGAM <a class="right" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" style="text-transform: capitalize;line-height: 125%;color: #595959">
                          &nbsp;&nbsp; (Cerrar Sesión)
