@extends('admin.templates.cuerpo_cotizador')
...
<div>
    <a class="left btn boton_guardar" href="{{route('aprobado', $pedido->id)}}" style="cursor: pointer;">
        <span>
            Aprobar pedido
        </span>
    </a>
    <a class="left btn boton_guardar" href="{{route('doc_insuficiente', $pedido->id)}}" style="cursor: pointer;">
        <span>
