<header>
    ...
    <nav class="navbar_principal navbar-default" role="navigation" style="">
        <div class="container" style="width: 89%;">
            <ul class="navb fuenteO hidden-xs">
                <div class="container-flex">

                    <li class=" item-flex"><a href="{{route('tienda.presupuestos')}}" class="itm-menu <?php if(isset($_GET['active']) && $_GET['active'] == 'accesorios'){ echo 'active-link';} ?>">PRESUPUESTOS</a></li>
                    ...
                    <li class=" item-flex"><a href="{{route('pedidostienda.index')}}" class="itm-menu <?php if(isset($_GET['active']) && $_GET['active'] == 'trabajos'){ echo 'active-link';} ?>">PEDIDOS</a></li>
