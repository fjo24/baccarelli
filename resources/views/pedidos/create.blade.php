...
<div class="container" style="width: 89%;">
                                    ...
                                    <div class="input-restriccion col l10 m10 s10">
                                        <p>
                                          <label>
                                            ...
                                            <span style="width: 430px;">{!!Form::text('telefono_encargado',null,['class'=>'form_login', 'placeholder' => $restriccion->nombre])!!}</span>
                                          </label>
                                        </p>
                                    </div>
                                    @endforeach
 ...
 <!--       <div class="row">
            <div class="col s12 m12">
                <div class="card blue-grey darken-1" style="border-radius: 6px">
                    <div class="card-action" style="">
                        <span class="presupuesto">
                            Item
                        </span>
