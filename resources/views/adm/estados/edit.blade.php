    ...
    <div class="col s12">
        ...
        <div class="row">
            ...
            <div class="input-field col l6 s12">
                ...
                <p>
                    <label>
                        <input class="with-gap" name="selector" type="radio" value="1" @if($estado->selector == '1') checked
                        @endif />
                ...
                <p>
                    <label>
                        <input class="with-gap" name="selector" type="radio" value="0" @if($estado->selector == '0') checked
                        @endif />
                        <span>Tienda</span>
                    </label>
                </p>
