...
<p>
      <label>
        <input class="with-gap" name="orden_compra" type="radio" value="1" @if($tienda->orden_compra == '1') checked @endif />
        <span>Si</span>
      </label>
    </p>
    <p>
      <label>
        <input class="with-gap" name="orden_compra" type="radio" value="0" @if($tienda->orden_compra == '0') checked @endif />
        <span>No</span>
      </label>
    </p>
            </div>
